...
function loadQuestions() {
  try {
    ...
    const questions = JSON.parse(data).questions; //Convert it to JavaScript object
    return questions;
  } catch (e) {
...
function askQuestion(question) {
  ...
  const choice = parseInt(input("Enter the number: "));
...
const numQuestions = parseInt(input("Enter the number of questions: "));
